...
## 🔥 About Me
- 💻 Skilled in **React Native, Next.js, MongoDB, SQL, and Strapi**
- ⚡ Built a **Rapido-style app** with real-time Firebase updates
- 🏗️ Developing a **facial recognition authentication system**
- 🚀 Working on a **cross-platform dating app**
- 🎵 Recently wrote my **first song** and looking for collaborations 🎶
...
A dynamic ride-booking system with **Firebase Realtime Database** for live updates.

### **🛍️ Blinkit-Like App**
An instant grocery delivery platform built with a seamless **checkout and Razorpay integration**.
